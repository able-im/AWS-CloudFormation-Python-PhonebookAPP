...
def find_records():
    if request.method == "POST":
        ...
        return render_template(
            ...
            keyword=keyword,
            show_result=True,
            developer_name="Artem",
        )
    else:
        return render_template("index.html", show_result=False, developer_name="Artem")
...
def delete_record():
    if request.method == "POST":
        ...
        return render_template(
            "delete.html", show_result=False, not_valid=False, developer_name="Artem"
        )
